...
from model_def import SleepStageMLP  # your MLP class
import glob
import os
...
class SleepDataset(Dataset):
    def __init__(self, directory="../processed"):
        ...
        self.X = self.X.reshape(num_epochs, num_channels * num_samples)
...
if __name__ == "__main__":
    ...
    model = SleepStageMLP(input_dim=input_size, num_of_classes=num_classes, dropout=0.5).to(device)
